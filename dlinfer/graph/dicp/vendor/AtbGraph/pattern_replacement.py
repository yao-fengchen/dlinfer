...
#         view_1 = torch.ops.aten.view.default(x, size1)
#         all_gather_into_tensor = (
#             torch.ops._c10d_functional.all_gather_into_tensor.default(
#                 view_1, group_size, group_name
#             )
#         )
...
#         view_2 = torch.ops.aten.view.default(cat, size2)
#         linear = torch.ops.dlinfer.linear.default(
#             view_2, weight, bias, all_reduce, lmdeploy_group_type
#         )
#         return linear
...
#         slice2,
#     ):
#         parallel_type = infer_param.ParallelType.ALL_GATHER_LINEAR
#         return torch.ops.dlinfer.linear_parallel.default(
#             x, weight, bias, parallel_type, group_name
#         )
